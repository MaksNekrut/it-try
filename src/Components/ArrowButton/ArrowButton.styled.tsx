...
export const StyledArrowButton = styled.button<({isRound: boolean})>`
    width: 50px;
    height: 50px;
    cursor: pointer;
    outline: none;
    border-radius:  ${({ isRound }) => isRound ? '50%' : 'none'};
    border: ${({ isRound }) => isRound ? `1px solid ${colors.darkBlue}` : 'none'};
    background: ${({ isRound }) => isRound ? colors.white : colors.darkBlue};
...
// export const StyledArrowButton = styled.button<StyledProps<IButton>>`
